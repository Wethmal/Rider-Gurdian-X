...
public class BikeAttitudeActivity extends AppCompatActivity {

    private static final String DEVICE_NAME = "HC-05";
    private static final String PHONE_NUMBER = "0769930678";
    private static final UUID MY_UUID =
            UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");

    private static final int REQ_ALL_PERMISSIONS = 1;
    private static final int REQ_BT_EXTRA = 100;
    private static final int REQ_SMS = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_attitude); 
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == REQ_ALL_PERMISSIONS || requestCode == REQ_BT_EXTRA) {
            ...
            for (int i = 0; i < permissions.length; i++) {
                if (grantResults.length > i &&
                    ...
                    allGranted = false;
                    deniedPerms.append(
                            permissions[i].replace("android.permission.", "")
                    ).append(", ");
                }
            }
            ...
            if (allGranted) {
                ...
                Toast.makeText(this,
                        "Denied: " + denied + ". Please enable in Settings.",
            ...
            Toast.makeText(this,
                    "SMS permission result received",
    ...
    private void connectHC05() {
        ...
        if (hc05 == null) {
            Toast.makeText(this,
                    "HC-05 not paired. Please pair in Bluetooth settings",
                    Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private void sendLocationSMS() {
        ...
        if (currentLatitude == 0.0 || currentLongitude == 0.0) {
            Toast.makeText(this,
                    "Location not ready. Please wait for GPS signal...",
                    Toast.LENGTH_LONG).show();
                ...
                fusedLocationClient.getLastLocation()
                        .addOnSuccessListener(location -> {
                            if (location != null) {
                                ...
                                updateLocationDisplay();
                                Toast.makeText(this,
                                        "Location acquired! Try sending again.",
                                        Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        ...
        String googleMapsUrl =
                "https://maps.google.com/?q=" +
                        currentLatitude + "," + currentLongitude;
        String message =
                "EMERGENCY! Accident detected. Location: " + googleMapsUrl;
        ...
        try {
            ...
            if (parts.size() > 1) {
                ...
                smsManager.sendMultipartTextMessage(
                        PHONE_NUMBER, null, parts, null, null);
                Toast.makeText(this,
                        "✅ SMS sent in " + parts.size() +
                                " parts to " + PHONE_NUMBER,
                        Toast.LENGTH_LONG).show();
            } else {
                
                smsManager.sendTextMessage(
                        PHONE_NUMBER, null, message, null, null);
                Toast.makeText(this,
